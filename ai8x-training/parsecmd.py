...
def get_parser(model_names, dataset_names):
    ...
    parser.add_argument('--tb-image-samples', default=0, type=int,
                        help='Number of MMS test and camera-test examples per split to log as '
                             'TensorBoard images')
    parser.add_argument('--tb-image-freq', default=10, type=int,
                        help='Log MMS test and camera-test images every N epochs')
